    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precio_costo', models.DecimalField(decimal_places=4, max_digits=12)),
                ('valor_costo', models.CharField(max_length=8)),
                ('modo_pago_c', models.CharField(max_length=8)),
            ],
        ),
        migrations.CreateModel(
            name='Cad_est_finan',
            fields=[
                ...
                ('tot_ingresos', models.DecimalField(decimal_places=4, max_digits=12)),
                ('tot_costo', models.DecimalField(decimal_places=4, max_digits=12)),
                ('saldo_finan', models.DecimalField(decimal_places=4, max_digits=12)),
            ],
        ),
        migrations.CreateModel(
            name='Cad_ing_ret',
            fields=[
                ...
                ('valor_ing_ret', models.DecimalField(decimal_places=4, max_digits=12)),
            ],
        ),
        migrations.CreateModel(
            name='Cad_insumos',
            fields=[
                ('cod_insumo', models.SmallIntegerField(primary_key=True, serialize=False)),
                ('nombre_insumo', models.CharField(max_length=50)),
                ('fecha_cadastro', models.DateField()),
            ],
        ),
        migrations.CreateModel(
            name='Cad_stock',
            fields=[
                ...
                ('valor_insumo', models.DecimalField(decimal_places=4, max_digits=12)),
                ('ind_ing_sal', models.CharField(choices=[('I', 'Ingreso'), ('S', 'Salida')], max_length=1)),
                ('modo_pago_m', models.CharField(choices=[('E', 'Efectivo'), ('T', 'Tarjeta')], max_length=1)),
                ('cod_insumo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadastroCostos.Cad_insumos')),
            ],
        ),
        migrations.CreateModel(
            name='Cad_un_med',
            fields=[
                ('un_med_insumo', models.SmallIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_veces', models.SmallIntegerField()),
                ('valor_vendido', models.DecimalField(decimal_places=4, max_digits=12)),
            ],
        ),
