...
urlpatterns = [
    ...
    url('listarStock', Cad_stock_List.as_view(), name='cad_stock_listar'),
    url('nuevoStockIngreso', Cad_stock_Create.as_view(), name='cad_stock_crear_ingreso'),
    url('nuevoStockSalida', Cad_stock_Create.as_view(), name='cad_stock_crear_salida'),
    url('detalleStock/(?P<pk>\d+)/$', Cad_stock_Detail.as_view(), name='cad_stock_detalle'),
    url('detalleStockInsumo/(?P<pk>\d+)/$', Cad_stock_Detail_Movimiento.as_view(), name='cad_stock_detalle_insumo'),
    url('editarStock/(?P<pk>\d+)/$', Cad_Stock_Update.as_view(), name='cad_stock_editar'),
